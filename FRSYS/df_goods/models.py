...
class TypeInfo(models.Model):
    ...
    ttitle = models.CharField(max_length=40, verbose_name="分类")
...
class GoodsInfo(models.Model):
    ...
    gtitle = models.CharField(max_length=40, verbose_name="商品名称", unique=True)
    ...
    gunit = models.CharField(max_length=40, default='500g', verbose_name="单位重量")
